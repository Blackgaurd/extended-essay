...
% ^ maybe too abstract
% how does an edt compare with other data classification algorithms of similar nature
...
% TODO: include diagram of labelled tree
...
% TODO: add diagram of solution space, local and global extrema
...
% how to compare edt fairly with other algos when parameters are so different?
% maybe investigate each hyperparameter of edt and see how it plays into its performance?
% - e.g. how different crossover probabilities affect convergence and test accuracy
% - or different selection splits
